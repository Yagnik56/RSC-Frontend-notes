// REACT – NOTE 2: CORE CONCEPTS (Interview Prep)
    ...
    <div>
      ...
      */}
      ...
      {/* 
        ...
        - It lets us write HTML-like syntax inside JS.
      ...
      */}
      ...
      {/* ---------------------------------- */}
      <h5>Ques 4: Difference between State and Props?</h5>
      ...
      */}
      ...
      {/* ---------------------------------- */}
      <h5>Ques 6: What is React Fragment?</h5>
      {/* 
        - Used to group multiple elements.
        - Does not add extra DOM node.
      */}
      <>
        <p>Paragraph 1</p>
        <p>Paragraph 2</p>
      ...
      {/* ---------------------------------- */}
      <h5>
        Ques 7: State in Functional Component & how it's different from variables?
      </h5>
      <Counter />

      {/* ---------------------------------- */}
      <h5>Ques 8: State in Class Component</h5>
      <CounterNew />

      {/* ---------------------------------- */}
      <h5>Ques 9: How do you pass props to a component?</h5>
      {/* Passed as attributes: <Component propName={value} /> */}
      ...
      */}
      {/* Used for runtime prop validation */}

      {/* ---------------------------------- */}
      <h5>Ques 11: How do you use props in a class component?</h5>

      {/* ---------------------------------- */}
      <h5>Ques 12: Export / Import in JS Modules?</h5>
      {/* 
        - Default export: one per file, any name allowed
        ...
        - Named export: multiple allowed, exact name required
      ...
      */}
      ...
      {/* 
        ...
        - Improves performance via diffing.
      ...
      */}
      ...
      {/*
        - Reconciliation: process of computing diff btwn old vs new Virtual DOM.
        - Rendering: applying those changes to actual DOM.
      */}

      {/* ---------------------------------- */}
      <h5>Ques 15: What is Diff Algorithm?</h5>
      {/*
...
class CounterNew extends React.Component {
  ...
  incrementCount() {
    // setState schedules an update, not immediate mutation
...
const Counter = () => {
  ...
  // State persists across renders, normal variables do not
